...
%   params = lambda,        k,           a,     gamma,     beta,     mu,      delta,     c]    
 params=[25104026	1.429e-12	      195	 0.214	   0.864	  0.045     0.105 	   2.35];
 lb = [25140000      1.45*10^(-12)    195      0.2       0.8      0.040     0.100       2];   
 ub = [2516000      1.35*10^(-12)     200      0.25      0.9      0.050     0.110       2.5];   
 % initial condition
